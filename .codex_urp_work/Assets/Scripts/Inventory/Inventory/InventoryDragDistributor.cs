...
{
    /// <summary>
    /// Statická třída řídící drag-distribute operace přes inventářní sloty.
    /// Symetrický protějšek CraftingDragDistributor pro hlavní inventář.
    ...
    /// Drag se aktivuje až od druhého najetého slotu.
    /// </summary>
    public static class InventoryDragDistributor
    {
        /// <summary>Množina slotů, přes které hráč přejel myší během dragu.</summary>
        private static HashSet<InventorySlot> hoveredSlots = new();
        ...
        private static HashSet<InventorySlot> appliedRightSlots = new();
        ...
        /// <summary>
        /// True, pokud drag pohltil kliknutí a InventorySlot.OnPointerClick() ho nemá zpracovávat.
        /// </summary>
        ...
        public static void BeginDrag(InventorySlot startSlot, bool isRightClick)
        {
        ...
        public static void HoverSlot(InventorySlot slot)
        {
        ...
        public static void EndDrag()
        {
            ...
            if (cursor.HeldSlot == null || cursor.HeldSlot.amount <= 0)
            {
                ...
                InventoryCursor.Instance.RefreshCursorUI();
            }
            else
                cursor.ForceRefresh();
        ...
        private static void Redistribute()
        {
            ...
            {
                var slot = InventoryData.Instance.Slots[slotUI.slotIndex];
            ...
            int remainder = startAmount - used;
            cursor.HeldSlot.amount = remainder;
        ...
        /// Přeskočí sloty s jiným itemem, plné sloty nebo sloty s jiným itemem než kurzor.
        /// </summary>
        /// <param name="slotUI">Inventářní slot, do kterého se vkládá 1 kus.</param>
        private static void ApplyRightDrag(InventorySlot slotUI)
        {
            ...
            if (!slot.IsEmpty && slot.amount >= slot.item.maxStack)
                return;
