...
namespace Orivilon.World.Terrain
{
    ...
    public class MapGenerator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (GameManager.selectedWorld != null && !string.IsNullOrEmpty(GameManager.selectedWorld.seed))
            {
                if (int.TryParse(GameManager.selectedWorld.seed, out int parsedSeed)) seed = parsedSeed;
            }
